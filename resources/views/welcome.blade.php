...
<header>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="wellcome-text">
                <div class="well-text text-center">
                  ...
                  <form action="{{route('pendingClients.store')}}" method="POST">
                    @csrf 
          ...
          <div class="team-top">
            <div class="col-md-3 col-sm-3 col-xs-12">
              <div class="single-team-member">
                <div class="team-img">
                  <a href="#">
                    <img src="img/team/corina tapia.jpg" alt="" />
                  </a>
    ...
    <!-- Fin Blog -->
    <!-- Inicio area de suscribirse -->
    <div class="suscribe-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs=12">
            <div class="suscribe-text text-center">
              <h3>Bienvenido a la microempresa villacis & asociados</h3>
              <a class="sus-btn" href="#">Consigue una cotización</a>
            </div>
          </div>
        </div>
      </div>
    </div>
    <!--  fin area de suscribirse -->
